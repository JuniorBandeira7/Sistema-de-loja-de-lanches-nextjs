...
const Card: React.FC<CardProps> = ({photoUrl, productName, price, description}) => {
    return (
        <a href="#" className="flex items-center bg-one border border-gray-200 rounded-lg shadow-sm md:flex-row hover:shadow-lg">
            <div className="flex flex-col justify-between p-4 leading-normal">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-white">{productName}</h5>
                <p className="mb-3 font-normal text-gray-300">{description}</p>
                <h6 className='text-white'>R$ {price}</h6>
            </div>
